    ...
    def get_augmentation(self, sentence, operation):
        ...
        for sent_item in sentence_list:
            ...
            if(len(augSentTexts) != 0):
                ...
                op_sent = sent_item ## If null - just take the original sentence as output
            
            output += op_sent

        ## this will be final output sentence  (can match the initial sentence sometime - will check where the function is called)
        return output
